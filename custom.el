(custom-set-variables
 ...
 '(safe-local-variable-values (quote ((opml-sync . t))))
...
(custom-set-faces
 ...
 '(org-property-value ((t (:foreground "grey"))) t)
 '(org-special-keyword ((t (:inherit font-lock-keyword-face :foreground "darkslategrey")))))
